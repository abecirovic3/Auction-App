INSERT INTO product (id, name, description, start_price, start_date, end_date) VALUES (1, 'Running shoes', 'Nike', 120.99, '2022-03-10', '2022-04-10');
INSERT INTO product (id, name, description, start_price, start_date, end_date) VALUES (2, 'Keyboard', 'Genius', 15.50, '2022-05-20', '2022-08-10');
INSERT INTO product (id, name, description, start_price, start_date, end_date) VALUES (3, 'Monitor', 'ASUS', 150.99, '2022-05-10', '2022-05-16');
INSERT INTO product (id, name, description, start_price, start_date, end_date) VALUES (4, 'CPU', 'AMD Ryzen', 170.99, '2022-09-12', '2022-11-21');
INSERT INTO product (id, name, description, start_price, start_date, end_date) VALUES (5, 'Ring', 'Gold Ring', 79.99, '2022-12-10', '2023-01-10');
INSERT INTO product (id, name, description, start_price, start_date, end_date) VALUES (6, 'Blanket', 'Wool', 20.25, '2022-03-18', '2022-03-26');
INSERT INTO product (id, name, description, start_price, start_date, end_date) VALUES (7, 'Chainsaw', 'STIHL', 550.99, '2022-06-23', '2022-07-29');
INSERT INTO product (id, name, description, start_price, start_date, end_date) VALUES (8, 'Mobile Phone', 'Samsung', 800.25, '2022-09-05', '2022-11-06');
